...
var cnItems = {
    ...
    "Increases WR of Aggro cards": "增加 暴怒 卡的 WR",
    ...
    "Auto signup": "自动报名",
    "Increases WR of cards with a different type than Control": "增加与控制类型不同的卡牌的 WR",
    "Show battle": "显示战斗",
    "Team": "团队",
    "Trophies": "奖杯",
    "1 trophy (": "1 奖杯（",
    ...
    "Increases WR of Control cards": "增加控制卡的 WR",
    "Increases WR of Combo cards": "增加组合卡的 WR",
    "Increases WR of Aggro cards in your deck. (Weakness of Control)": "增加牌组中 暴怒 卡的 WR。（控制的弱点）",
    "multiplicative": "乘法",
    ...
    "Daniel": "丹尼尔",
    "Increases WR of cards with a different type than Combo": "增加与 组合 不同类型的卡牌的WR",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^\+([\d\.,]+) pack supply \/ tick$/, '\+$1 卡包供应 \/ tick'],
    [/^\+([\d\.,]+) money \/ tick$/, '\+$1 金钱 \/ tick'],
    [/^Day ([\d\.,]+)$/, '天数 $1'],
